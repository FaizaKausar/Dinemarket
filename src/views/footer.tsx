...
const Footer = () => {
  return (
    <section>
      <div
        className="flex md:justify-around  px-24 py-12 md:py-24 flex-col md:flex-row items-left md:items-center
"
      >
        <div>
          <Image src={logo} alt="logo" height={150} width={150} />
          <p className="text-[#666] font-serif text-lg mt-8">
            Small, artisan label that offers a <br /> thoughtfully curated
            collection of high quality <br /> everyday essentials made
          </p>
      ...
      <div className="flex justify-between md:items-center text-[#666] px-24 md:px-20 items-left gap-y-4 mt-6 mb-4 flex-col md:flex-row ">
        <p className="text-md md:text-lg md:w-[200px]">
        ...
        <p className="text-sm md:text-lg">
          Code by.
          <span className="font-bold text-[#212121]">shabrina12 on github</span>
        </p>
      </div>
    </section>
  );
